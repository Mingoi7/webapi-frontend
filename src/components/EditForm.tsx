...
const EditForm: React.FC = (props:any) => {
   ...
   // console.log("aa  ", aa)
    ...
    const contentRules = [
      ...
      const handleFormSubmit  = (values: any) => {
       ...
       console.log(`path: ${api.uri}/pets${props.aid}`)
        axios.put(`${api.uri}/pets/${props.aid}`, postPet, {
            headers: {
       ...
       {console.log(`path: ${api.uri}/pets`)
        axios.post(`${api.uri}/pets`, postPet, {
        headers: {
          'Authorization': `Basic ${localStorage.getItem('aToken')}`
        }
      })
  ...
  return (
    ...
    <p></p>
    {props.isNew?(<Title level={3} style={{color:"#0032b3"}}>Create New Pet</Title>):(<Title level={3} style={{color:"#0032b3"}}>Update Pet</Title>)}
